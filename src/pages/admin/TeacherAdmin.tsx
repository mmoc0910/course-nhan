...
const TeacherAdmin = () => {
  ...
  const fetchData = async () => {
    try {
      const result = await axiosPrivate.get<AuthType[]>("/users?role=3");
        ...
        render: (_, record) => (
          <div className="font-primary flex items-center gap-2">
            ...
            <button
              ...
              type="button"
              className={classNames("px-2 py-1 rounded-lg font-semibold text-white", record.enable ? "bg-error" : "bg-primary20")}
            >
