const Satify = () => {
  return (
    <div className="container grid grid-cols-3 py-7 rounded-2xl bg-primary my-10">
      <div className="flex flex-col items-center text-white gap-1">
        ...
        <p className="font-medium text-2xl">17 năm</p>
        <p className="text-xl">Giáo dục trực tuyến</p>
      </div>
      <div className="flex flex-col items-center text-white gap-1">
        <span>
          <svg
        ...
        <p className="font-medium text-2xl">100.000.000</p>
      ...
      <div className="flex flex-col items-center text-white gap-1">
        ...
        <p className="font-medium text-2xl">Số 1 Việt Nam</p>
        <p className="text-xl">Nền tảng học trực tuyến</p>
      </div>
    </div>
  );
};

export default Satify;
