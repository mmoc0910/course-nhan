    ...
    <div className="relative">
      <textarea
        ...
        className={classNames(
          "scroll-hidden outline-none text-sm focus:border-primary font-medium placeholder:text-text4 py-[15px] px-[25px] rounded-[10px] border border-solid w-full bg-inherit peer resize-none ",
          error?.message
