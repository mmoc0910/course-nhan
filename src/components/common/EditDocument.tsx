...
const EditDocument = memo(
  ({
    ...
    handleEditDocument: (title: string, url: string) => void;
      ...
      <div className="col-span-2 grid grid-cols-3 gap-5">
        ...
        <div className="flex items-center gap-5">
          <button
            ...
            type="button"
            className="px-5 py-3 rounded-lg bg-primary20 font-medium text-white w-max"
          >
            Chỉnh sửa
          </button>
          <button
            ...
            type="button"
            className="px-5 py-3 rounded-lg bg-error font-medium text-white w-max"
          >
            Xóa tài liệu
          </button>
        </div>
